...
using Fusion.Services.Identity.MainModule.Account;
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> Login(LoginInputModel model, string button)
        {
             ...
             if (ModelState.IsValid)
            {
                ...
                //var result = await _signInManager.CheckPasswordSignInAsync(model.Username, model.Password, model.RememberLogin);
